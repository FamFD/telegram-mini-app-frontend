@font-face {
  ...
  font-style: normal;
  font-weight: 400;
  src: url(https://fragment.com/fonts/ProductSansRegular.ttf);
}
@font-face {
  font-family: ProductSans;
  font-display: swap;
  font-style: bold;
  font-weight: 600;
  src: url(https://fragment.com/fonts/ProductSansBold.ttf);
}
...
.tm-logo-progress .tm-logo-icon {
  --image-url-logo-icon-animated: url('https://fragment.com/img/TelemintLogoSprite2.svg');
